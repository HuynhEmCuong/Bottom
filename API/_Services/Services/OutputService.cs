...
namespace Bottom_API._Services.Services
{
    public class OutputService : IOutputService
    {
        ...
        public async Task<List<OutputMain_Dto>> GetListOutputInfo(List<string> listTransacNo, string qrCodeId)
        {
            ...
            var listTransactionMainByTransferForm = _repoTransactionMain.FindAll().Where(x => listTransacNo.Contains(x.Transac_No) && x.Can_Move == "Y");
            // dữ liệu output cần hiển thị: trong bảng tranasaction main, transaction detail ...
        ...
        {
            var listTransactionDetailByTransacNo = await _repoTransactionDetail.FindAll().Where(x => listTransacNo.Contains(x.Transac_No))
